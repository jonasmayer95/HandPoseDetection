...
In our implementation the RRP was represented by a set of 50 relaxed hand postures recorded with the Leap Motion Controller. The metric \textbf{RRP(x)} was simply computed by calculating the minimum euclidean distance of a hand denoted as a multi-dimensional vector ``x" to the RRP set.
...
We conducted a total of two user studies, a pilot study featuring the hand posture evaluation only and the main study, where both target shooting and hand posture evaluation were tested. 
