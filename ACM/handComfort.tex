...
\title{A Basic Metric for Hand Comfort/Discomfort Evaluation} 
...
We computed the \textbf{abduction} component \textbf{FA(x)} by adding up the absolute abduction angle for the finger. This is possible as a fully adducted finger has an abduction angle of 0 in our model.
...
The studies were conducted with 12 and 15 participants respectively, whereof 2 and 5 were female. The participants' mean age was ??? and 21.
Subjects were informed about the aim of the study as well as their specific objectives beforehand. 
