...
When creating a interface for hand posture computer interaction, comfort and discomfort of the chosen hand postures are often considered in order to create a most positive user experience. However, so far no concrete metric exists, for quickly comparing the comfort and discomfort of different hand postures. In this paper a straightforward metric, based on the hand anatomy, for quick comfort and discomfort evaluation of non-resting hand postures is presented. In different user studies, the correctness of this metric as well as it's impact on the precision and performance have been indicated.
\end{abstract}
